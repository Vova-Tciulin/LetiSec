...
namespace LetiSec.Migrations
{
    ...
    [Migration("20221127121110_addNewRole_update")]
    partial class addNewRole_update
    {
            ...
            modelBuilder.Entity("LetiSec.Models.DbModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@mail.ru",
                            Name = "Vladimir",
                            Password = "AQAAAAEAACcQAAAAEP7uH+x8808hr8AGLL5SXBnVrO0heuBn2MTu96RuctkmfO2jMqpKzGmSwfYhd0I2yQ==",
                            RoleId = 1
                        });
                });
