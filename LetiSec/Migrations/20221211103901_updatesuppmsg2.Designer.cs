...
namespace LetiSec.Migrations
{
    ...
    [Migration("20221211103901_updatesuppmsg2")]
    partial class updatesuppmsg2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LetiSec.Models.DbModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@mail.ru",
                            Name = "Vladimir",
                            Password = "AQAAAAEAACcQAAAAECN5KDTwMGI7r9ivFg3VhtcsVP4lU+W3vYfgD2wbnC1rUxTY+Ql2jkOybbcxAIOV4Q==",
                            RoleId = 1
                        });
                });
