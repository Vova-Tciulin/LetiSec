...
namespace LetiSec.Migrations
{
    ...
    [Migration("20221211104316_updatesuppmsg3")]
    partial class updatesuppmsg3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LetiSec.Models.DbModel.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin@mail.ru",
                            Name = "Vladimir",
                            Password = "AQAAAAEAACcQAAAAEKsBJlcdxZGQOd4oD8+lJV0/9XYItnHJcnuzH7nvT3xUZoBTBK79E1HJPU13clUQTA==",
                            RoleId = 1
                        });
                });
